...
ft_rrr ft_pa ft_pb print_lst check_sorted
PS_RAW = push_swap sort get_distances get_distance_dst \
find_high_low calc_path find_target add_instruction \
src_r_dst_r src_rr_dst_rr src_r_dst_rr src_rr_dst_r \
sort_three rotate_lowest_to_top sort_short sort_short_halves
